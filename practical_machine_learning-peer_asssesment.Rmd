...
We will work with the this csv file. There is also another file without the outcome column ("classes"), that can be used to predic these missing values. Here I'll only take the latter into consideration to determine which are the values I van really choose to build a valid model.
...
```{r}
var_importance <- varImp(model)[order(var_importance$Overall,
